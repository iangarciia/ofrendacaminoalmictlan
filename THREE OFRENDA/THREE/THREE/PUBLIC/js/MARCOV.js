...
export default function MARCOV({x,y,z}){
...
var texturaFoto = new THREE.TextureLoader().load("./assets/cat4.png");
...
//scene.add(Foto);
    ...
    const MARCOV1 = new THREE.Group();
    MARCOV1.add(marco, Foto);
    MARCOV1.position.set(x,y,z);
