...
export default function vela3({x,y,z}){

//vela1
var geo1 = new THREE.CylinderGeometry(0.8, 0.6, 3, 20, 10, false, 0, 8);
var texture = new THREE.TextureLoader().load("./assets/v3.jpg");
//trasladar
texture.offset.x=0;
texture.offset.y=0;
...
var mesh3 = new THREE.Mesh(geo3,mat3);
    ...
    const vela3 = new THREE.Group();
    vela3.add(mesh,mesh2,mesh3);
    vela3.position.set(x,y,z);
